import pytz
from trueclean.settings import ADMIN_EMAIL,FRONTEND_URL,ADMIN_PHONE,BREVO_API_KEY
...
projectName = project_info.project_name if project_info else 'True Clean'
adminEmail = project_info.admin_email if project_info else ADMIN_EMAIL

adminPhone = project_info.admin_phone if project_info else ADMIN_PHONE

frontendDomain = project_info.frontend_domain if project_info else FRONTEND_URL
